...
> Bundle live. Five skills, one Project Knowledge block, all wired. Try `/heavy-proposal` next time you bid a $500K+ pursuit.
>
> The artifacts are plain text. You own them. Edit any time. To add a new GC quirk profile, open the Project Knowledge block and append a section. To change the pricing engine math, edit pricing-engine SKILL.md. To add a fifth jury lens, edit proposal-review-jury SKILL.md.
>
> If you want a v2 with auto-loaded supplier quote parsing, AIA G702 generation, or BIM-tied takeoff math. Treat that as a self-build target: extend the skills yourself when the need shows up.
